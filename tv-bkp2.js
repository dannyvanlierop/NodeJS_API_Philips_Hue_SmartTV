...
|
\***********************************************************************************************************************************************************************************************/
//exports.returnJSONObj = function(cb){
//  client.get('/lights/' + iLightNumber + '/', function (err, result) {
//     if ( err || typeof result.state.transitiontime === undefined  ){ return err; }
//
//      /**/ cb(result); }); };
//exports.returnJSONObj = function(){

exports.returnJSONObj = function(){

    var pos = arrayUpdatePreSet();
    var someReturnValue;
    var getOptions = {
    ...
    var req = http.request( getOptions, function(res) {
      res.on('data', function(chunk){
        //console.log("RESULT On(chunk) : -> " + chunk);
        data += chunk;
      });
      res.on('end', function(){ 
        //console.log("RESULT End(data) : -> " + data);
        //someReturnValue = JSON.parse(data);
        arrayUpdateSet(pos, data);
        });
    });
    console.log(arrayUpdateGet(pos));
    req.end();
...
exports = returnValueArrayTv = {};
   ...
   //setTimeout(function(){ 
    //console.log("RESULT Return(someReturnValue) : -> " + someReturnValue);
    //return JSON.stringify(someReturnValue);                               //someReturnValue
    //}, 50);                           //someReturnValue
}
...
//    var Sometestfunction = function(someReturnValue) {
//        // if error condition?
...
//            Sometestfunction = someReturnValue;
//
//        }
//    }
//
//    setTimeout(function(){ 
//    console.log("RESULT Return(someReturnValue) : -> " + JSON.stringify(someReturnValue));
//    
//    return data;                            //someReturnValue
//    }, 100);   
...
//    console.log("RESULT Return(someReturnValue) : -> " + someReturnValue);
//    
//    return someReturnValue;                               //someReturnValue
//    }, 50);                         //someReturnValue
//
//    }
//    return "test";
...
//    var data;
//    var getOptions = { hostname: '192.168.0.97', port: 1925, path: path, method: 'GET', headers: { 'Content-Type': 'text/html', 'Content-Length': Buffer.byteLength("") } };
//
//
//    var req = http.request( getOptions, function(res) {
//      res.on('data', function(chunk){     console.log("RESULT On(chunk) : -> " + chunk);      data = chunk;     });
//      res.on('end',  function( ){
//        console.log("RESULT End1(data) : -> " + data);
...
//exports.returnJSONObj = function(path, res){
//
//    var getOptions = {
//      hostname: '192.168.0.97',
//      port: 1925,
...
//
//    var data = {};
//    var req = http.request( getOptions, function(res, cb) {
//      res.on('data', function(chunk){
//        console.log("RESULT On(chunk) : -> " + chunk);       //data += chunk;
//        data = chunk;
//      });
//      res.on('end', function(){ 
//        console.log("RESULT End1(data) : -> " + data);
...
//    var options = {
//        url: 'http://192.168.0.97:1925/5/ambilight/cached',
//        headers: {
//          'Content-Type': 'text/html',
//          'Content-Length': Buffer.byteLength("")
//        }
